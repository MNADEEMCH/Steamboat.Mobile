...
namespace Steamboat.Mobile.ViewModels
{
    public class MenuViewModel : ViewModelBase
    {
        ...
        private void OnNotificationHandler(object sender, PushNotificationEventParam pushNotificationEventParam)
        {
            ...
            if (pushNotification.Type.Equals(PushNotificationType.CoachMessage)){
                if (pushNotificationOpenedByTouch){
                    GetSupportMenuItem().NotificationsCount = 0;
                    SelectItem(GetSupportMenuItem(), false);
                }else 
                    GetSupportMenuItem().NotificationsCount = pushNotification.Badge;
        ...
        private Models.Menu.MenuItem GetSupportMenuItem(){
            return MenuItems.Where(mi => mi.Title.Equals("Support")).First();
        }
        ...
        private void InitMenuItems(MainViewModelInitParameter initParameter)
        {
            ...
            var selectedItem = isDispositionStepSelected ? GetDispositionStepMenuItem() : GetSupportMenuItem();
