...
namespace Steamboat.Mobile.iOS.Controls
{
    ...
    public class CheckBoxView : UIButton
    {
        ...
        void ApplyStyle()
        {
            SetImage(UIImage.FromBundle("Checkbox/on.png"), UIControlState.Selected);
            SetImage(UIImage.FromBundle("Checkbox/off.png"), UIControlState.Normal);
        }
    }
}
