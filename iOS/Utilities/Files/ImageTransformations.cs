...
namespace Steamboat.Mobile.iOS.Utilities.Files
{
    public static class ImageTransformations
    {
        ...
        public static UIImage RotateImage(this UIImage sourceImage, int orientation)
        {
            var uiImageOrientation = UIImageOrientation.Up;
            ...
            return UIImage.FromImage(sourceImage.CGImage, 1.0f, uiImageOrientation);
        }
    }
}
